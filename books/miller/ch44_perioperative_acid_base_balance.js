...
Perioperative Acid-Base Balance — Anesthesia Board Review`
    },
    {
...
Perioperative Acid-Base Balance — Anesthesia Board Review`
    ...
    {
      title: `_H2O → H_<sup>_+_</sup> _+ OH_<sup>_−_</sup>`,
...
The ion-product dissociation constant for water ( **_Kw_** ) is expressed as:`
    ...
    {
      title: `_Keq × [H2O] = Kw = [H_<sup>_+_</sup> _][OH_<sup>_−_</sup> _]_`,
...
**Dependent variables** include **_[H_**<sup>**_+_**</sup> **_]_** , pH, **_[OH_**<sup>**_−_**</sup> **_]_** , **_[HCO3−]_** , carbonate ( **_[CO32−]_** ), and the un-dissociated weak acids ( **_[HA]_** and **_[A_**<sup>**_−_**</sup> **_]_** ). They must automatically shift to satisfy the three governing laws whenever an independent variable is altered. Crucially, **_[H_**<sup>**_+_**</sup> **_]_** and **_[HCO3−]_** cannot be altered independently; the addition of **_H+_** alone without a corresponding strong anion cannot permanently influence the pH of the system.`
    ...
    {
      title: `_Mathematical Determination of Hydrogen Ion Concentration_`,
...
Perioperative Acid-Base Balance — Anesthesia Board Review`
    ...
    {
      title: `_1. Respiratory Alkalosis_`,
...
- **Perioperative Etiologies:** Preoperative anxiety; postoperative pain, agitation, or a full urinary bladder; or, most commonly, an inappropriately aggressive intraoperative mechanical ventilation strategy.`
    ...
    {
      title: `_2. Respiratory Acidosis_`,
...
**3. Obstructed Breathing:** Signals an **Airway Problem** (Airway Obstruction). Localized anatomically to supraglottic, glottic, subglottic, or reactive bronchospasm.`
    ...
    {
      title: `_Pathophysiology of Metabolic Acidosis_`,
...
Temporary bedside control of severe uremic acidosis can be achieved via intravenous sodium bicarbonate administration, provided the patient possesses sufficient alveolar ventilation to fully exhale the resulting **_CO2_** load.`
    ...
    {
      title: `_4. Hyperchloremic Acidosis & Saline Nephrotoxicity_`,
...
Perioperative Acid-Base Balance — Anesthesia Board Review`
    ...
    {
      title: `_<mark>IX. Comprehensive Analysis of Acid-Base Diagnostic Tools</mark>_`,
    ...
    {
      title: `_1. The Boston Descriptive School (CO2-Bicarbonate Relationship)_`,
    ...
    {
      title: `_2. The Copenhagen School (Base Excess Framework)_`,
...
_To correct for hemoglobin and ECF equilibration errors, modern blood gas analyzers report the_ **_Standard Base Excess (SBE)_** _utilizing the following formula:_`
    ...
    {
      title: `_3. Traditional vs. Modern Anion Gap Calculations_`,
...
- **_> 2.0:_** _Signals a mixed disorder where a pre-existing metabolic alkalosis or chronic respiratory compensation artificially elevates the baseline bicarbonate concentration (e.g., a vomiting patient who subsequently develops lactic shock)._`
    ...
    {
      title: `_4. Advanced Physical Chemistry Tools: SIG & Base Deficit Gap_`,
...
Perioperative Acid-Base Balance — Anesthesia Board Review`
    ...
    {
      title: `_<mark>X. Master Summary of Diagnostic Reference Tables</mark>_`,
...
|**_Metabolic Alkalosis_**|**_ΔPaCO2 = 0.6 × ΔBE_**_(Hypoventilation upregulates_**_PaCO2_**_retention)_|`
    ...
    {
      title: `_Table 44.4: Perioperative Acid-Base Disturbances Summary Table_`,
      content: `Page 14 of 24 

Perioperative Acid-Base Balance — Anesthesia Board Review 

|**_Disorder Profile_**|**_Primary Iatrogenic & Pathological Anesthetic Causes_**|
|---|---|
...
Perioperative Acid-Base Balance — Anesthesia Board Review`
    ...
    {
      title: `_Table 44.2: Inter-relationship of Independent Variables and Clinical Pathology_`,
...
**_Check Serum Osmolar Gap:_** _If Osmolar Gap > 10 mOsm → Suspect acute toxic alcohol ingestion (toxic metabolite poisoning from ethylene glycol or methanol)._`
    ...
    {
      title: `_<mark>XII. Management & Targeted Therapeutic Interventions</mark>_`,
    ...
    {
      title: `_1. Sodium Bicarbonate (NaHCO3) Therapy_`,
...
_Bicarbonate should be used with extreme caution in circulatory shock or active ketoacidosis and has no proven therapeutic value in resolving ketoacidosis._`
    ...
    {
      title: `_2. Correction of Fluid and Electrolyte Deficits_`,
...
Perioperative Acid-Base Balance — Anesthesia Board Review`
    ...
    {
      title: `_<mark>XIII. Anesthesia Board Exam Practice Questions</mark>_`,
      content: `#### **_QUESTION 1_** 

**_A 58-year-old female with a history of Type 2 diabetes mellitus presents for urgent debridement of a necrotizing soft tissue infection of her right lower extremity. Her home medications include an SGLT-2 inhibitor, which she took the morning of surgery. Intraoperatively, she remains hemodynamically stable, but a routine arterial blood gas reveals the following values: pH 7.24, PaCO2 28 mm Hg, PaO2 95 mm Hg, [HCO3−] 12 mEq/L, and a blood glucose of 145 mg/dL. Point-of-care fingerstick testing reveals a blood 3-beta-hydroxybutyrate level of 4.5 mmol/L. Which of the following represents the most appropriate initial management strategy for this patient?_** 

- _A. Initiate a rapid volume infusion of 0.9% Normal Saline to correct volume depletion and discontinue insulin._ 

- _B. Administer 50 mEq of intravenous sodium bicarbonate to correct the base deficit._ 

- _C. Initiate fluid resuscitation with a glucose-containing balanced crystalloid and a continuous intravenous insulin infusion._ 

- _D. Consult nephrology for emergency continuous kidney replacement therapy (CKRT) to filter out unmeasured uremic waste._ 

##### **_Correct Answer: C_** 

**_Explanation:_** _This patient is presenting with Euglycemic Ketoacidosis (EDKA), a dangerous metabolic variant strongly linked to SGLT-2 inhibitors. EDKA is characterized by severe ketoacidosis (3-BOHB > 2 mmol/L, metabolic acidosis) with normal or near-normal blood glucose levels (<200 mg/dL), which can easily mislead clinicians. The text notes that standard hospital hyperglycemic DKA protocols are inappropriate. Treatment requires gentle volume resuscitation with glucose-containing balanced fluids (to stimulate endogenous insulin release and facilitate ketone clearance) coupled with an intravenous insulin infusion and close electrolyte management. Resuscitating with 0.9% Normal Saline (Option A) is incorrect because it induces a severe hyperchloremic metabolic acidosis that can mask resolution. Sodium bicarbonate (Option B) is not indicated and has no therapeutic value in resolving ketoacidosis. CKRT (Option D) is reserved for advanced renal failure or refractory uremic hyperkalemia; it is not an effective primary treatment for ketoacidosis._ 
...
**_A 68-year-old male with severe chronic obstructive pulmonary disease (COPD) is admitted to the intensive care unit post-laparotomy. His preoperative serum chemistry panel demonstrated a total CO2 content of 33 mEq/L. He is currently mechanically ventilated. The morning blood gas reveals: pH 7.51, PaCO2 40 mm Hg, and [HCO3−] 31 mEq/L. The ICU team is attempting to wean the patient from the ventilator, but he exhibits minimal spontaneous respiratory effort. What is the primary pathophysiological cause of his failure to wean?_** 

_A. Acute uremic renal failure resulting in the uncompensated retention of uremic acids._ 

- _B. Post-hypercapnic metabolic alkalosis induced by over-ventilation relative to his physiological chronic baseline._ 

- _C. Persistent acute respiratory acidosis due to inadequate mechanical minute ventilation settings._ 

_D. Dilutional acidosis secondary to excessive intraoperative hypotonic fluid administration._ 

##### **_Correct Answer: B_** 

**_Explanation:_** _According to the text, a baseline total_ **_CO2_** _of 33 mEq/L in a chronic COPD patient indicates a long-standing, chronic respiratory acidosis with a compensatory baseline_ **_PaCO2_** _of approximately 70 mm Hg. The patient's kidneys have adapted by excreting chloride, leading to a high baseline bicarbonate. Mechanically ventilating this patient to a standard_ **_PaCO2_** _of 40 mm Hg represents iatrogenic over-ventilation, creating a severe post-hypercapnic metabolic alkalosis (pH 7.51, bicarbonate 31 mEq/L). The body's primary physiological response to metabolic alkalosis is hypoventilation to retain_ **_CO2_** _. This suppresses the medullary respiratory drive, resulting in low spontaneous respiratory effort and a failure to wean. Minute ventilation must be reduced to allow the_ **_PaCO2_** _to return to the patient's native chronic baseline (65–70 mm Hg)._ 
...
**_A critically ill trauma patient is evaluated in the intensive care unit. Laboratory analysis reveals a serum sodium of 140 mEq/L, chloride of 106 mEq/L, and a bicarbonate of 15 mEq/L. The patient's serum albumin is severely reduced at 12 g/L. Utilizing standard traditional calculations, the clinician notes an uncorrected anion gap of 19 mEq/L. Which of the following statements most accurately reflects the interpretation of this patient's metabolic status?_** 

- _A. The uncorrected anion gap of 19 mEq/L accurately quantifies the true extent of unmeasured organic anion accumulation._ 

- _B. The patient has a pure hyperchloremic non-gap metabolic acidosis with no unmeasured organic anion burden._ 

- _C. The true organic anion gap is significantly wider than calculated because severe hypoalbuminemia masks the expansion of the gap._ 

- _D. Hypoalbuminemia acts as a strong acidifying force, artificially widening the calculated traditional anion gap._ 

##### **_Correct Answer: C_** 

**_Explanation:_** _Serum albumin is a weak acid and carries the primary unmeasured negative charge in normal plasma. In critical illness, hypoalbuminemia is common. The text states that for every 10 g/L drop in serum albumin below normal (~42 g/L), the baseline normal anion gap drops by 2.5 mEq/L. This patient's albumin has dropped by 30 g/L, meaning their native normal baseline anion gap is only around 4.5 mEq/L instead of 12 mEq/L. An uncorrected calculated anion gap of 19 mEq/L actually represents a massive, life-threatening accumulation of hidden unmeasured anions (such as lactate or uremic waste) that is heavily masked by the concurrent hypoalbuminemia. Applying the Fencl-Figge correction:_ **_AGCorrected = 19 + 0.25 × (42 − 12) = 19 + 7.5 = 26.5 mEq/L_** _, revealing a widened organic gap acidosis. Hypoalbuminemia itself drops_ **_ATOT_** _and acts as an alkalinizing force, not an acidifying one._ 
...
**_An anesthesia provider is titrating mechanical ventilation parameters intraoperatively for an uncompromised patient undergoing major spine surgery. The patient is receiving an aggressive volume resuscitation. According to the text, which of the following statements regarding the administration of 0.9% Normal Saline versus balanced salt solutions is correct?_** 

- _A. Normal saline has an independent Strong Ion Difference (SID) of 35 mEq/L, matching native human ECF._ 

- _B. Infusing a single liter of normal saline imposes a negligible workload on the kidneys due to the high storage capacity for chloride in skeletal tissue._ 

- _C. Large-volume normal saline infusions induce dense renal vasoconstriction, reduce renal blood flow velocity, and decrease glomerular filtration rates._ 

- _D. Anephric renal transplant patients resuscitated with normal saline exhibit significantly lower serum potassium levels compared to those treated with Lactated Ringer's._ 

##### **_Correct Answer: C_** 

**_Explanation:_** _The text outlines that normal saline possesses an independent strong ion difference of zero (_ **_SID = 0_** _) because it contains sodium and chloride in an unphysiological 1:1 ratio (154 mEq/L each). Infusing it floats a massive chloride burden into the body. Because the human body lacks a dedicated mechanism to store chloride, infusing 1 liter of saline forces an immediate 8- to 10-fold increase in the renal metabolic excretory workload to clear it. Elevated chloride levels are directly nephrotoxic: saline infusions cause dense renal vasoconstriction, severely reduce renal blood flow velocity, and significantly decrease glomerular filtration rates (GFR). In a landmark study of anephric patients undergoing renal transplantation, resuscitating with normal saline caused worse metabolic acidosis and significantly higher, more dangerous hyperkalemia compared to Lactated Ringer's, making Option D incorrect._ 
...
**_A 45-year-old patient in the intensive care unit is being evaluated for new-onset, unexplained metabolic acidosis following major abdominal surgery. The point-of-care blood gas analyzer reports a normal L-lactate level of 1.1 mEq/L, but the corrected anion gap and standard base deficit gap remain significantly widened. The patient has a history of short bowel syndrome and recent intestinal bacterial overgrowth. Which of the following best explains these findings?_** 

- _A. Accelerated aerobic glycolysis driven by therapeutic infusions of exogenous epinephrine._ 

- _B. Accumulation of hidden D-lactate produced via bacterial fermentation, which is invisible to standard point-ofcare blood gas analyzers._ 

- _C. Saline-induced hyperchloremic metabolic acidosis that selectively widens the strong ion gap._ 

- _D. Profound contraction alkalosis caused by the aggressive administration of loop diuretics._ 

##### **_Correct Answer: B_** 

**_Explanation:_** _The text explicitly notes that in patients with short bowel syndrome and intestinal bacterial overgrowth, bacterial fermentation can overproduce the D-lactate isoform. D-lactate acts as a strong organic anion, reducing the ECF SID and manifesting as a widened anion gap or strong ion gap acidosis. Crucially, standard point-of-care blood gas analyzers are exclusively calibrated to detect the human L-lactate isoform, rendering D-lactate entirely invisible on a routine ABG panel. D- lactate-induced acidosis must be diagnosed via a dedicated, specific laboratory send-out assay. Catecholamine-driven aerobic glycolysis (Option A) produces human L-lactate, which would be visible. Saline infusions (Option C) cause a non-anion gap acidosis (normal gap). Loop diuretics (Option D) provoke a contraction alkalosis, not a widened gap metabolic acidosis._ 
