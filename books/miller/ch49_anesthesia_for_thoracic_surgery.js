export const ch49 = {
  ...
  sections: [
    {
      title: `COMPREHENSIVE BOARD REVIEW & STUDY GUIDE`,
...
#### **Leg 1: Respiratory Mechanical Function** 

Spirometric parameters correlate directly with postresection respiratory complications. The single most valid mechanical test is the **predicted postoperative forced expiratory volume in one second (** **_ppoFEV1%_ )** . 
...
#### **Leg 3: Cardiopulmonary Interaction (Exercise Capacity)** 

The final and most critical dimension evaluates how the heart and lungs interact under physiological stress. Preoperative exercise capacity is the single best predictor of outcome in geriatric patients. 
...
**Indication:** Strongly indicated for any patient undergoing a **pneumonectomy** whose baseline preoperative **_FEV1_** or **_DLCO is < 80%_** . It has very limited utility for predicting outcomes in standard lobectomies.`
    ...
    {
      title: `3. Concomitant Medical Conditions: Core Board Pearls`,
      content: `#### **A. Cardiac Disease and Ischemia** 

Lung resections are legally categorized as **intermediate-risk procedures** for perioperative cardiac events. Postthoracotomy ischemia has an incidence of 5%, characteristically peaking on **postoperative days 2 to 3** . Antiplatelet/stenting delay mandates include a minimum delay of 4 to 6 weeks after bare-metal stents and 6 months after drug-eluting stents. Major antiplatelet agents must be safely held prior to surgery, with the explicit exception of aspirin. 

#### **B. Postoperative Atrial Fibrillation (AF)** 

Dysrhythmias complicate 30% to 50% of major pulmonary resections within the first postoperative week, with 60% to 70% manifesting as atrial fibrillation. The core etiology is multifactorial but driven by two interactive mechanisms: (1) permanent or transient elevations in pulmonary vascular 
...
#### **C. Pulmonary Hypertension (PH) Management Principles** 

Anesthesiologists must distinguish PH due to left heart disease from PH due to chronic lung disease (cor pulmonale), as their responses to standard cardiovascular medications are completely inverted. Patients with cor pulmonale depend entirely on tonic cardiac sympathetic drive for right ventricular (RV) contractility and hemodynamic stability. 
...
#### **D. Chronic Obstructive Pulmonary Disease (COPD) & Ventilatory Control** 

Anesthesiologists must understand the physiological realities of the "CO2 retainer": 
...
#### **E. Malignancy Specifics: The "4 M's"** 

|**Category**|**Specific Pathophysiology**|**Anesthetic Implication & Management Strategy**|
|---|---|---|
...
1. **VivaSight DLT:** Incorporates an integrated high-definition video camera embedded at the distal end of the endotracheal lumen, providing continuous visual verification of the tracheal carina on a monitor screen. It includes an in-situ flushing system to clean the lens. It significantly accelerates placement and can eliminate the need for flexible bronchoscopy, minimizing aerosolization risks 
...
Page 8`
    ...
    {
      title: `5. Positioning and Physiology of the Lateral Decubitus Position`,
      content: `#### **Neurovascular Injury Prevention** 

The lateral decubitus position places unique physical stress on neurovascular structures: 
...
#### **Ventilation-Perfusion (V/Q) Mismatch under General Anesthesia** 

The matching of ventilation and perfusion degrades significantly upon transitioning from the conscious, awake state to general anesthesia with paralysis and mechanical ventilation in the lateral decubitus position: 
...
Page 9`
    ...
    {
      title: `6. Anesthetic Management of One-Lung Ventilation (OLV)`,
      content: `#### **A. Restrictive Fluid Management Guidelines** 

Excessive intravenous fluid administration causes immediate hydrostatic fluid shifting into the dependent, ventilated lung due to the gravitational distribution of pulmonary blood flow, causing rapid alveolar edema and severe shunting. Fluid therapy must be strictly judicious and restricted: 
...
#### **C. Ventilatory Optimization Strategy** 

Historical ventilation strategies using massive tidal volumes (10 mL/kg) to prevent hypoxemia are highly injurious, triggering severe barotrauma, volutrauma, and shear stress (atelectrauma) in the 
...
2. **Gradual / Standard Desaturation:** 
   ...
   - If hypoxemia persists, utilize partial ventilation methods (intermittent positive-pressure ventilation of the operative lung with a small 70 mL **_VT_** at a rate of 6/min) or requests mechanical restriction of the operative lung's blood flow (clamping or inflating a PA catheter balloon). The final line of rescue is the initiation of venovenous ECMO.`
    ...
    {
      title: `7. Anesthetic Management for Specific Surgical Interventions`,
      content: `#### **A. Tracheal Resection & Reconstruction** 

Indicated for high-grade stenosis or tumors. Intratracheal masses present a critical risk of complete airway obstruction upon induction of general anesthesia, behaving identically to anterior mediastinal 
...
Utilized for lymph node staging in NSCLC. The most severe, life-threatening complication is major hemorrhage from a tear in the superior vena cava or pulmonary artery. 
...
#### **C. Pneumonectomy & Postpneumonectomy Pulmonary Edema** 

Complete removal of a lung triggers immediate, permanent increases in right ventricular afterload due to a severe reduction in the available pulmonary vascular bed. 
...
#### **E. Anterior/Superior Mediastinal Masses & "NPIC" Strategy** 

Masses in the anterior or superior mediastinum risk catastrophic airway obstruction and complete cardiovascular collapse (due to compression of the main pulmonary artery or atria) upon induction of general anesthesia. Life-threatening collapse can occur in completely asymptomatic pediatric patients due to compressible cartilaginous airways. Tracheobronchial compression **> 50% on CT scan is an absolute contraindication to general anesthesia**. 
