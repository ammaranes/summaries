...
into a near-real-time cardiac output estimate.`
    ...
    {
      title: `5. High-Yield Anesthesia Board Review Questions`,
      content: `Question 1
Anesthesiologists adjusting a patient's bedside monitor switch from diagnostic mode (0.05–150 Hz)
to monitoring mode (0.5–40 Hz) to eliminate baseline respiratory artifact. What is the expected
mechanical effect of this change on the tracked waveforms? 
A. Pacemaker spikes are amplified and highlighted in a secondary color trace.
B.  Phase  nonlinearities  can  induce  artifactual  J-point  depression  and  upsloping  ST-segment
shifts.
C. High-frequency 60-Hz wall power interference is selectively eliminated by an inline notch filter.
D. The natural frequency of the dynamic system expands, widening the acceptable range of
damping coefficients.
Correct Answer: B. Phase nonlinearities can induce artifactual J-point depression and upsloping ST-
segment shifts.
Explanation: According to the text, changing the low-frequency high-pass filter cutoff from 0.05 Hz up to 0.5 Hz
introduces phase nonlinearities where the frequency content changes abruptly, such as the junction of the QRS
complex and the ST segment. This artifactually distorts the ST segment, producing false J-point depression and
upsloping deviations. Narrowing the high-frequency cutoff to 40 Hz suppresses or eliminates pacing spikes
rather than amplifying them (Choice A). Complete eradication of 60-Hz noise via integrated notch filters occurs
in Filter Mode (0.5–20 Hz), not standard monitoring mode (Choice C). Changing display filter settings does not
alter the physical natural frequency of an invasive line system (Choice D). 
• 
Anesthesia Board Review Series • Cardiovascular Monitoring Page 9 of 15

Question 2
A  68-year-old  male  with  severe  chronic  thromboembolic  pulmonary  hypertension  (CTEPH)
undergoes a prolonged abdominal tumor debulking under positive-pressure mechanical ventilation.
The baseline arterial catheter exhibits a Pulse Pressure Variation (PPV) score of 16%. Following a
500  mL  crystalloid  bolus,  his  stroke  volume  drops,  and  mean  airway  pressures  rise.  Which
pathophysiologic feature best explains this response? 
A. Left ventricular subendocardial demand ischemia causing an abrupt fall in diastolic ventricular
compliance.
B.  Right  ventricular  afterload  over-activation  and  subsequent  right  heart  failure  induced  by
...
Correct  Answer:  B.  Right  ventricular  afterload  over-activation  and  subsequent  right  heart  failure
induced by elevated intrathoracic pressures.
Explanation: The  text  explicitly  warns  that  patients  with  severe  pulmonary  hypertension  or  reduced  right
ventricular ejection fraction do not demonstrate consistent, predictable responses to respiratory intrathoracic
pressure variations. Volume challenges in this cohort carry a high risk of worsening right heart failure due to
right ventricular afterload over-activation. While a PPV > 13% typically implies volume responsiveness in a
normal left ventricle, it is rendered an invalid predictor in right-sided pump failure, where fluid loading shifts the
failing RV further down its compliance curve. 
Anesthesia Board Review Series • Cardiovascular Monitoring Page 10 of 15

Question 3
A dynamic pressure tracking system displays a slurred systolic upstroke, a completely absent dicrotic
notch, and a falsely narrowed pulse pressure profile on the monitor screen. However, the calculated
Mean  Arterial  Pressure  (MAP)  matches  a  concurrent  manual  validation.  What  is  the  optimal
...
C. Advance the indwelling catheter tip beyond the local vascular border to counter distal pulse
amplification.
D. Reposition the secondary external transducer 5 cm anterior to the sternomanubrial junction.
Correct Answer: B. Purge the pressure tubing line to remove microscopic air bubbles or localized
blood clotting.
Explanation: The presence of a slurred systolic upstroke, an erased dicrotic notch, and a falsely narrowed pulse
pressure with an accurate MAP is the classic signature of an *overdamped system*. The text outlines that
overdamping is commonly caused by decreases in fluid energy from components like air bubbles, blood clots,
loose connections, or kinks. Flushing or purging the system restores baseline tracking. Replacing components
for underdamping (Choice A) is incorrect, as underdamping produces systolic overshoot and ringing waves.
Moving the transducer alignment (Choice D) shifts hydrostatic baselines but does not correct dampening
artifacts. 
Anesthesia Board Review Series • Cardiovascular Monitoring Page 11 of 15

Question 4
During a complex orthopedic revision in the right lateral decubitus position, an indwelling radial artery
catheter located in the nondependent (up) left wrist registers a direct blood pressure of 120/80 mm
Hg. The external transducer sits securely aligned at the patient's mid-thoracic level. An automated
noninvasive  blood  pressure  (NIBP)  cuff  applied  to  the  dependent  (down)  right  arm  cycles
concurrently. If the physical height distance from the dependent arm up to the left heart border spans
exactly 20 cm, what is the expected NIBP display reading? 
A. 120/80 mm Hg
B. 105/65 mm Hg
C. 135/95 mm Hg
D. 150/110 mm Hg
...
Explanation: The text notes that as long as an invasive transducer remains properly leveled at the heart line,
direct arterial lines record accurate values regardless of arm position. However, noninvasive cuff measurements
fluctuate based on the physical arm position relative to the heart due to hydrostatic pressure differences. For an
arm positioned below the heart level (dependent down arm), gravity adds to the column of fluid. The text
explicitly states that a 20-cm height discrepancy creates a 15 mm Hg shift. Thus, the dependent cuff will read
15 mm Hg higher than the actual heart pressure: 120 + 15 = 135 systolic, and 80 + 15 = 95 diastolic. 
Anesthesia Board Review Series • Cardiovascular Monitoring Page 12 of 15

Question 5
Which of the following perioperative patient scenarios will prompt a true pulmonary artery wedge
pressure (PAWP) measurement to significantly *underestimate* the patient's actual left ventricular
end-diastolic pressure (LVEDP)? 
A. A patient with severe mitral valve regurgitation demonstrating massive, early-systolic regurgitant
v waves.
B. A patient with severe chronic mitral stenosis exhibiting a 12 mm Hg diastolic trans-valvular
pressure gradient.
C. A patient with acute, severe aortic insufficiency causing premature closure of the mitral valve
before end-diastole.
D. A patient on high-dose positive end-expiratory pressure (PEEP) ventilation promoting alveolar
capillary compression.
Correct Answer: C. A patient with acute, severe aortic insufficiency causing premature closure of the
mitral valve before end-diastole.
Explanation: In acute aortic regurgitation, retrograde blood flow from the aorta rapidly fills the left ventricle
during diastole. This elevates ventricular pressure prematurely, forcing the mitral valve to snap shut before end-
diastole. The trapped LVEDP rises sharply, but this pressure increase cannot be transmitted backward into the
left atrium or pulmonary circuit. Consequently, the PAWP underestimates the actual LVEDP. In contrast, mitral
regurgitation  (Choice  A),  mitral  stenosis  (Choice  B),  and  high  PEEP  levels  (Choice  C)  all  cause  an
*overestimation* of the LVEDP by the registered PAWP. 
Anesthesia Board Review Series • Cardiovascular Monitoring Page 13 of 15

Question 6
A patient newly admitted to the intensive care unit following an open aortic reconstruction requires
placement of an internal jugular central venous catheter. While using ultrasound guidance to identify
local anatomy, the provider observes that an interface between two adjacent neck structures has a
very high acoustic impedance mismatch. How will this interface manifest on the ultrasound screen? 
...
Explanation: Based on the ultrasound physics principles in the regional anesthesia source document, an
acoustic  impedance  mismatch  (differences  in  acoustic  properties)  between  two  adjacent  tissues  drives  a
reflection of sound waves. The amount of energy reflected correlates directly with the degree of difference in
impedance. The greater this energy reflection, the brighter (more hyperechoic) the object appears on the
ultrasound screen. Uniform acoustic properties produce hypoechoic interiors (Choice B is false), and speed
variances across lean vs. adipose interfaces cause bayonet artifacts (Choice C). 
Question 7
An anesthesia provider attempts to perform an ultrasound-guided popliteal sciatic nerve block at a
depth of 5 cm in a muscular adult male. The nerve trunk appears faint and blurry with poor lateral
resolution. Which machine adjustment is most appropriate to optimize image clarity at this depth? 
A. Switch to a higher frequency linear transducer to expand deep tissue penetration.
B. Switch to a lower frequency transducer to minimize wave attenuation and bring the focal point
to 5 cm.
C. Maximize the total gain control to clear up localized acoustic enhancement artifact.
D. Advance the needle at a completely perpendicular 90-degree angle to align color Doppler
signals.
Correct Answer: B. Switch to a lower frequency transducer to minimize wave attenuation and bring the
focal point to 5 cm.
Explanation: The regional anesthesia reference guide states that high-frequency ultrasound waves improve
image resolution but suffer from high tissue attenuation (conversion to heat), which limits their penetration
depth to less than 3 cm. For structures deeper than 3–5 cm, a lower frequency transducer must be used. Lower
frequency waves penetrate deep tissues more effectively due to lower attenuation, allowing the provider to
resolve deep structures and adjust the focus zone to the level of the target nerve to maximize resolution. 
Anesthesia Board Review Series • Cardiovascular Monitoring Page 14 of 15

Question 8
A patient develops severe agitation, generalized tonic-clonic seizures, and cardiovascular collapse
immediately following a supraclavicular brachial plexus block with 0.5% bupivacaine. According to
standard American Society of Regional Anesthesia (ASRA) guidelines for Local Anesthetic Systemic
Toxicity (LAST), which modifications to standard ACLS protocols are mandatory? 
A.  Administer  standard  1  mg  intravenous  epinephrine  boluses  and  avoid  amiodarone  for
arrhythmias.
B. Avoid vasopressin administration, and restrict individual epinephrine boluses to small doses
less than 1 mcg/kg.
C. Inject high-dose propofol immediately to sequester local anesthetic molecules from cardiac
myocytes.
D. Avoid chest compressions to prevent lipid emulsion displacement from the central vascular
bed.
Correct Answer: B. Avoid vasopressin administration, and restrict individual epinephrine boluses to
small doses less than 1 mcg/kg.
Explanation: The  regional  anesthesia  documentation  outlines  that  resuscitating  a  patient  in  LAST  differs
significantly  from  standard  ACLS.  Correct  protocols  mandate  avoiding  vasopressin  entirely  and  reducing
individual epinephrine boluses to less than 1 mcg/kg. Standard high-dose epinephrine boluses can worsen
local anesthetic-induced arrhythmias and impair myocardial recovery. Propofol (Choice C) must not be used as
a substitute for lipid emulsion if the patient exhibits cardiovascular instability. Chest compressions must be
continued aggressively to circulate the lipid rescue therapy. 
Anesthesia Board Review Series • Cardiovascular Monitoring Page 15 of 15`
    }
  ]
};
