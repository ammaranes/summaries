export const ch25 = {
  ...
  sections: [
    {
      title: `LOCAL ANESTHETICS`,
      content: `_Comprehensive Study Guide & Board Review Framework (Miller's Anesthesia, Ch. 25)_ 
...
Anesthesia Board Review Series: Local Anesthetics 
...
#### **_pH = pKa + log10([B] / [BH_**<sup>**_+_**</sup> **_])_** 

Reversible protonation tends to make local anesthetics less charged at a more basic pH and more charged at a neutral or acidic pH. In inflamed or infected tissues, the local pH drops substantially. This shifts the equilibrium toward the charged protonated form ( **_BH_**<sup>**_+_**</sup> ), which cannot easily penetrate the perineurium and neuronal membrane, ultimately culminating in poor neural block or clinical failure.`
    },
    {
...
A 59-year-old male with a history of a full stomach presents for emergency surgical debridement of a lower extremity wound. Immediately following a popliteal sciatic nerve block using a large mass dose of bupivacaine, the patient develops muscular twitching, quickly progressing to generalized tonic-clonic seizures and subsequent bradycardia with profound hypotension. Which of the following represents the most appropriate initial step in the pharmacological management of this condition? 

A. Administer an intravenous bolus of 1 mg epinephrine and 40 units of vasopressin to restore coronary perfusion pressure. 

B. Perform immediate endotracheal intubation, provide 100% oxygen with hyperventilation to induce respiratory alkalosis, and start a lidocaine infusion. 

C. Prioritize airway securement, ensure normocapnia with 100% oxygen, and administer a 1.5 mL/kg ideal body weight bolus of Intralipid 20%. 

D. Terminate the seizure with a large induction dose of propofol (2 mg/kg) and place a nasopharyngeal airway. 

##### **Correct Answer: C** 

**Explanation:** The patient is demonstrating classical signs of Local Anesthetic Systemic Toxicity (LAST) secondary to a bupivacaine injection, progressing rapidly from CNS excitation to cardiovascular depression. The cornerstone of management is immediate airway protection with 100% oxygen while maintaining strict normocapnia, alongside the immediate initiation of lipid emulsion therapy (Intralipid 20% as a 1.5 mL/kg bolus). Option A is incorrect because high-dose epinephrine can worsen bupivacaineinduced arrhythmias, and vasopressin is completely contraindicated in LAST guidelines. Option B is incorrect because hyperventilation is no longer recommended (normocapnia should be targeted to avoid shifting free drug fractions), and lidocaine is an amide local anesthetic that would compound the existing toxic sodium channel block. Option D is incorrect because large doses of propofol cause severe myocardial depression, which can precipitate catastrophic cardiovascular collapse in a hemodynamically unstable LAST patient. 
...
During an ultrasound-guided femoral nerve block for a total knee arthroplasty, the interventionalist aims to minimize the required drug volume to achieve an effective block. Based on current clinical evidence regarding the minimum local anesthetic volume (MLAV) required under precise ultrasound guidance, what is the estimated optimal volume normalized to nerve size? 

A. 0.50 – 0.75 mL per mm<sup>2</sup> of nerve cross-sectional area 

B. 0.10 – 0.15 mL per mm<sup>2</sup> of nerve cross-sectional area 

C. 1.0 – 1.5 mL total volume, independent of the nerve cross-sectional diameter 

D. 0.01 – 0.05 mL per mm<sup>2</sup> of nerve cross-sectional area 

##### **Correct Answer: B** 

**Explanation:** Precision localization with ultrasound guidance allows for a significant reduction in the volume of local anesthetic required to block peripheral nerves. The minimum local anesthetic volume (MLAV) normalized to nerve structure is estimated to be 0.10 to 0.15 mL per mm<sup>2</sup> of nerve cross-sectional area. It must be noted clinically that while a minimized volume can produce an effective sensory block at 30 minutes, it may reduce the overall duration of the block compared to traditional high-volume techniques. 
...
A patient presents with severe, burning pain over a well-healed thoracotomy scar that is exquisitely sensitive to light touch. This clinical presentation is diagnosed as neuropathic pain featuring prominent allodynia. Which of the following statements best describes the underlying cellular mechanism and preferred first-line pharmacological treatment according to the WHO and clinical guidelines? 

A. It is driven by peripheral sensitization and a lowering of nociceptor firing thresholds; it should be treated initially with a long-acting opioid like methadone. 

B. It represents a state of chronic hyperexcitability of sensory nerves; first-line therapy includes anticonvulsants like gabapentin or tricyclic antidepressants like nortriptyline. 

C. It is caused by an up-regulation of skeletal muscle sodium channel isoforms (Nav1.4); it should be managed with regional sympathetic ganglion blocks. 

D. It is mediated exclusively by an energy crisis within the motor end-plate zones; it requires high-dose NSAID therapy with ketorolac. 

##### **Correct Answer: B** 

**Explanation:** The patient is experiencing post-thoracotomy neuropathic pain characterized by allodynia (pain in response to a normally non-painful stimulus, such as light touch). Neuropathic pain is driven by peripheral and central sensitization, resulting in chronic hyperexcitability of injured sensory nerves. Firstline pharmacotherapy for chronic neuropathic pain consists of anticonvulsants (gabapentinoids like gabapentin or pregabalin) or antidepressants (tricyclic compounds like nortriptyline/amitriptyline, or SNRIs like duloxetine). While methadone is an effective opioid for neuropathic pain due to its NMDA antagonist properties, it is considered a second-line or third-line agent, reserved for palliative care or scenarios where first-line therapies have completely failed. Nav1.4 is specific to skeletal muscle and not involved in this sensory nerve pathology. 
...
An interventional pain physician is requested to perform a diagnostic lumbar medial branch block to address chronic, non-radiating low back pain that is markedly exacerbated by lumbar spine extension and rotation on physical examination. If the degenerative changes are isolated to the right L4-L5 zygapophyseal (facet) joint, which specific nerves must be targeted to ensure a complete diagnostic block? 
...
**Explanation:** Lumbar zygapophyseal (facet) joints receive a dual nerve supply derived from the primary dorsal rami medial branches at the same anatomical level and the level immediately above. Therefore, the L4-L5 facet joint is innervated by the L4 medial branch and the L3 medial branch. To achieve complete diagnostic anesthesia of the L4-L5 joint, both the L3 and L4 medial branches must be blocked. (Note: For the L5-S1 joint, the targets would be the L4 medial branch and the L5 dorsal ramus). 

##### **Question 5** 

A 26-year-old female patient scheduled for an emergency outpatient surgical procedure reports that she was diagnosed with inherited local anesthetic resistance after multiple failed dental blocks. Molecular sequencing in these rare hereditary families has demonstrated mutations localized to which specific structural region of the voltage-gated sodium channel alpha-subunit? 
...
C. The transmembrane segment IIIS6 contributing to the inner vestibule drug-binding pharmacophore. 

D. The cytoplasmic loop connecting domain D-3 and D-4 responsible for fast inactivation. 

##### **Correct Answer: C** 

**Explanation:** True genetic resistance to local anesthetics, though rare, has been mapped to point mutations within the S6 transmembrane segments (specifically the IIIS6 segment) of the channel's alpha subunit. The S6 segments from domains D-1, D-3, and D-4 converge to form the inner vestibule of the channel, which constitutes the receptor binding site (Site 9) for local anesthetics. Point mutations in these domains reduce the binding affinity of the channel for the local anesthetic molecule, preventing functional impulse inhibition. The D3-D4 loop mediates fast inactivation, and S4 segments contain the positive gating charges responsible for voltage sensing, neither of which represents the primary local anesthetic binding pharmacophore. 
