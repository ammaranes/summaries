export const ch23 = {
  ...
  sections: [
    {
      title: `INTRAVENOUS DRUG DELIVERY SYSTEMS`,
      content: `_Comprehensive Board Review & Study Guide | Reference: Miller's Anesthesia Chapter 23_`
    },
    {
...
#### **_d/dt(PaCO2) = ke1 • [1 - (Ceγ / (C50γ + Ceγ))] • [PbiophaseCO2(t) / PbiophaseCO2(0)]Γ_** 

Where **_ke1_** represents the elimination rate constant for **_CO2_** , **_C50_** is the effect-site opioid concentration provoking a 50% reduction in baseline ventilatory drive, and **_Γ_** reflects the physiological gain or steepness of the **_CO2_** effect on ventilation.`
    },
    {
...
#### **_Vdpe = Bolus amount / Cpe_** 

To accurately achieve a desired therapeutic biophase target without risking a toxic overshoot, the loading bolus must be calculated as follows: 

#### **_Loading dose = CT × Vdpe_**`
    },
    {
...
Page 13`
    ...
    {
      title: `<mark>7. Comprehensive Board-Style Exam Questions</mark>`,
      content: `The following high-yield, multiple-choice questions replicate the format and clinical complexity of the Anesthesia Board Examination. All questions are derived strictly from the reference text. 

##### **Question 1: Comparative Pharmacokinetics and Model Selection** 

A 45-year-old female with a body mass index (BMI) of 52 kg/m² is scheduled for an elective laparoscopic cholecystectomy under Total Intravenous Anesthesia (TIVA). The anesthesia provider utilizes a TargetControlled Infusion (TCI) system. Which of the following statements accurately characterizes model selection and demographic covariate handling for this patient? 

**A.** The Schnider propofol model should be selected because it incorporates lean body mass (LBM) using the James equation, ensuring perfect clearance predictions across all extremes of body weight. 

**B.** The Marsh propofol model scales its parameters exclusively using body weight, meaning it will accurately predict plasma concentrations in this patient if total body weight is entered without modification. 

**C.** The Eleveld general purpose model utilizes the Al-Sallami formula to calculate fat-free mass (FFM), avoiding the mathematical limitations of the James equation which can yield negative values in morbidly obese patients. 

**D.** The Minto remifentanil model utilizes allometric scaling based on total body weight with a fixed ¾ power exponent, making it mathematically stable for this patient. 

##### **Correct Answer: C** 

**Rationale:** The reference text states that the James equation (used in the Schnider propofol and Minto remifentanil models) exhibits a distinct quadratic behavior that makes it invalid for the morbidly obese, as it can yield impossible, negative lean body mass values. The Eleveld model replaces the James equation with the Al-Sallami formula for fatfree mass (FFM), which is widely applicable and produces stable, realistic predictions in the morbidly obese. Option A is incorrect because the James equation fails in this cohort. Option B is incorrect because the Marsh model significantly underestimates plasma concentrations if total body weight is entered without modification in obese patients; an adjusted weight is mandatory. Option D is incorrect because the Minto model utilizes the flawed James equation, not allometric scaling of total body weight. 
...
An anesthesia provider seeks to establish an explicit effect-site target concentration of 3.0 ng/mL of fentanyl to attenuate hemodynamic reactivity prior to a difficult endotracheal intubation. Based on the compartmental volumes provided in the text ( **_V1 = 12.7 L_** , **_Vdpe = 75 L_** , and **_Vdss = 360 L_** ), which of the following statements represents the most accurate dosing strategy and outcome? 

**A.** Administering an initial loading bolus of 39 mcg based on **_CT × V1_** will maintain the target concentration at the effect site for at least 15 minutes. 

**B.** Administering an initial loading bolus of 225 mcg based on **_CT × Vdpe_** will achieve a peak effect-site concentration of 3.0 ng/mL in approximately 3.6 minutes without creating a dangerous plasma overshoot. 

**C.** Administering an initial loading bolus of 1080 mcg based on **_CT × Vdss_** is the preferred method to saturate all peripheral tissues instantly, ensuring a rapid onset. 

**D.** The maintenance infusion rate must be held constant at the exact product of **_CT × ClS_** immediately following the loading bolus to prevent a rapid decline in biophase concentration. 

##### **Correct Answer: B** 

**Rationale:** The text explains that the apparent volume of distribution at the time of peak effect ( **_Vdpe_** ) must be used to calculate a loading dose ( **_Loading dose = CT × Vdpe_** ) to achieve a desired biophase target without risking a toxic overshoot. For fentanyl, **_3.0 ng/mL × 75 L = 225 mcg_** , which reaches peak effect site concentration at 3.6 minutes (matching Table 23.1). Option A is incorrect because a 39 mcg bolus achieves the target in plasma for only a transient instant, and effect-site levels will never approach 3.0 ng/mL due to rapid distribution. Option C is incorrect because a 1080 mcg bolus creates a massive, toxic plasma overshoot that persists for hours. Option D is incorrect because a simple maintenance infusion based on clearance severely underestimates the required rate initially; the infusion must initially be high to replace drug distributing into peripheral tissues and step-down over time. 
...
A patient is undergoing an extensive abdominal procedure under total intravenous anesthesia. The clinician wants to design an infusion regimen that optimizes the speed of emergence at the conclusion of a 10-hour surgery. Based on the Vuyk simulation surfaces and interaction models detailed in the text, which strategy ensures the most rapid return of consciousness? 

**A.** For a propofol-fentanyl technique, maintain a high fentanyl target (>6 ng/mL) to allow the propofol target to be reduced below 1.5 mcg/mL, as fentanyl clearance accelerates over time. 

**B.** For a propofol-fentanyl technique, target a fentanyl concentration of 1.0 to 1.5 ng/mL paired with a propofol concentration of 3.0 to 3.5 mcg/mL. 

**C.** For a propofol-remifentanil technique, limit the remifentanil concentration to <1.0 ng/mL and maximize the propofol concentration to ensure that the context-sensitive half-time of propofol is minimized. 

**D.** Escalate the intraoperative sufentanil concentration well above 0.15 ng/mL, as high opioid targets actively accelerate hypnotic emergence via synergistic receptor cross-activation. 

##### **Correct Answer: B** 

**Rationale:** According to the text and accompanying simulations by Vuyk and colleagues, the optimal drug combination for the most rapid recovery following a propofol-fentanyl anesthetic is a propofol concentration of 3.0 to 3.5 mcg/mL combined with a fentanyl target of 1.0 to 1.5 ng/mL. Option A is incorrect because high fentanyl concentrations shift the recovery trajectory to areas of the surface where emergence times are significantly prolonged. Option C is incorrect because for remifentanil, higher targets (5 to 7 ng/mL) are preferred because they allow the propofol concentration to be reduced to 2.0 to 2.5 mcg/mL, accelerating emergence to under 6 minutes. Option D is incorrect because maintaining sufentanil targets above the analgesic range (>0.15 ng/mL) or alfentanil targets above 80 ng/mL provides no additional clinical benefit and delays recovery. 
...
During a board examination review session on intravenous drug delivery hardware and front-end pharmacology, a candidate is asked to explain why standard polyexponential compartment models exhibit inaccuracies during the first 60 seconds following a rapid IV bolus injection. Which of the following options represents the correct scientific explanation provided in the text? 

**A.** Standard models fail because they assume an immediate, instantaneous mixing of the drug in the central compartment at **_t = 0_** , ignoring the 30- to 45-second transit time required to travel from the venous injection site to the arterial circulation. 

**B.** Standard models overpredict initial clearances because they assume that first-pass pulmonary uptake occurs exclusively via the slowly equilibrating peripheral compartment ( **_V3_** ). 

**C.** According to Henthorn's recirculatory model, arterial concentrations are purely composed of fully mixed-recirculated drug from the moment of injection, rendering venous sampling irrelevant. 

**D.** Masui and colleagues demonstrated that the early pharmacologic phase of propofol is entirely independent of the infusion rate, meaning transit compartments are static. 

##### **Correct Answer: A** 

**Rationale:** The text explicitly notes that the standard standard pharmacokinetic model assumes complete mixing within the central compartment such that the peak concentration occurs precisely at time zero. However, it takes 30 to 45 seconds for a drug to transit from the venous injection site to the arterial circulation. This model misspecification creates inaccuracies immediately post-bolus. Option B is incorrect because first-pass pulmonary uptake is included in the central compartment ( **_V1_** ). Option C is incorrect because Henthorn's model showed that arterial concentrations have two distinct components: partially (lung-mixed) drug and fully mixed-recirculated drug. Option D is incorrect because Masui demonstrated that early phase propofol kinetics *are* influenced by the infusion rate, requiring 6 transit compartments and an age-dependent LAG term to model accurately. 
...
A clinical investigator is setting up an institutional protocol for the administration of dexmedetomidine via a Target-Controlled Infusion (TCI) pump. Which of the following technical details regarding the Hannivoort-Colin dexmedetomidine model must be correctly integrated to ensure safe practice? 

**A.** Due to an exceptionally fast plasma-to-effect-site equilibration profile, effect-site targeting is the only commercially available mode for dexmedetomidine. 

**B.** The model maps an identical, single equilibration rate constant ( **_ke0_** ) for all physiological endpoints, including BIS, heart rate, and blood pressure. 

**C.** Because of very slow plasma-effect site equilibration, only plasma-controlled TCI for dexmedetomidine is clinically available at this moment. 

**D.** Concomitant administration of dexmedetomidine at a dose of 1 mcg/kg over 10 minutes in children profoundly alters and escalates the propofol **_EC50_** requirement. 

##### **Correct Answer: C** 

**Rationale:** The text states that "Due to the very slow plasma–effect-site equilibration, only plasma-controlled TCI for dexmedetomidine is clinically available at this moment." Option A is incorrect because the equilibration is very slow, not fast, ruling out commercial effect-site targeting. Option B is incorrect because the Colin expansion identified highly distinct, independent **_ke0_** values for different endpoints (BIS = 0.120 min<sup>-1</sup> , MOAA/S = 0.04 min<sup>-1</sup> , HR = 

0.396 min<sup>-1</sup> ). Option D is incorrect because Hammer and colleagues concluded that the pediatric propofol **_EC50_** was completely unaffected by a concomitant dexmedetomidine infusion of 1 mcg/kg over 10 minutes. 
...
An anesthesia department is conducting a clinical trial evaluating advanced computer-controlled drug delivery systems. A researcher compares a Proportional-Integral-Derivative (PID) closed-loop controller, a model-based adaptive controller, and a deep learning neural network system. Which of the following findings is consistent with the pharmacological data and text? 

**A.** Standalone PID controllers are highly stable when tracking sedation because delivering a "negative drug infusion" allows them to instantly reverse an overshoot. 

**B.** Struys and colleagues demonstrated that under extreme control conditions, such as low BIS levels or abrupt target adjustments, a model-based adaptive controller significantly outperforms a traditional PID controller. 

**C.** A deep learning neural network approach requires complex a priori assumptions regarding compartmental volumes and clearances to successfully predict BIS outputs. 

**D.** The addition of automated closed-loop control of remifentanil in a multi-input single-output system was shown by Canadian investigators to degrade the overall safety and quality of propofol titration. 

##### **Correct Answer: B** 

**Rationale:** The text notes that using simulations, Struys and colleagues compared their model-based adaptive controller with a previously published PID controller and found that the model-based controller outperformed it under extreme control conditions, such as low and high BIS levels and abrupt changes. Option A is incorrect because directly counteracting the administration of excessive drug is not possible (negative infusions are impossible), making standalone PID tuning highly difficult due to pharmacologic variability. Option C is incorrect because the "deep learning" neural network approach operates "without the need to start with models based on current knowledge" or traditional compartmental parameters, yet remarkably learns to predict BIS values more accurately than traditional PK/PD model-based approaches. Option D is incorrect because the addition of automatic control of remifentanil significantly *improved* the quality of control. 
