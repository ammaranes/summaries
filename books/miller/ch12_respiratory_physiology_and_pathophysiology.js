...
QUESTION 1
During a preoperative evaluation, a 64-year-old male scheduled for an open low anterior resection
undergoes Cardiopulmonary Exercise Testing (CPET). Which of the following specific CPET parameters is
recognized as the most accurate predictor of serious postoperative pulmonary complications?
...
CORRECT ANSWER: D
Rationale: The text states: "...the ratio of minute ventilation to VCO_2 which is a measure of the efficiency of gas
exchange and reflects ventilation-perfusion matching and dead space, has been shown to predict more accurately than
VO_2 max the risk of postoperative pulmonary complications, and a threshold of ˙V_E/˙V_CO_2 > 35 is used to identify
high-risk patients." Options A and B represent valid CPET risk thresholds mentioned in the text, but the text explicitly
states that this ratio is more accurate than VO_2 max.
QUESTION 2
A 45-year-old patient undergoing a laparoscopic appendectomy demonstrates a significant increase in the
area of baseline dependent atelectasis on a research ultrasound. However, the anesthesia provider notes that
the patient's intrapulmonary shunt fraction has paradoxically decreased and arterial oxygenation has
improved. What mechanism explains this finding?
...
CORRECT ANSWER: B
Rationale: The text states: "Nonetheless, shunt is reduced and arterial oxygenation is mostly improved during CO_2
pneumoperitoneum. This paradox—more atelectasis and less shunt—suggests that efficient redistribution of blood flow
away  from  collapsed  lung  regions  is  attributable  to  hypercapnic  acidosis  CO_2  potentiating  hypoxic  pulmonary
vasoconstriction." Option D is incorrect because anesthesia decreases compliance from 95 to 60 mL/cmH₂O.
Anesthesia Board Review Series
CONFIDENTIAL & PROPRIETARY - BOARD STUDY GUIDE Page 17

QUESTION 3
An anesthesia provider is preoxygenating a healthy patient prior to a standard induction. To establish a
substantial oxygen reservoir while avoiding the development of absorption atelectasis, which of the following
interventions is supported by the text?
...
CORRECT ANSWER: C
Rationale: The text states: "Application of CPAP 10 cmH2O permitted the use of 100% inspired O2 without formation of
significant degrees of atelectasis." Option B is incorrect because while 30% oxygen eliminates atelectasis, it shortens the
safety margin significantly.
QUESTION 4
A patient with a history of severe chronic obstructive pulmonary disease (COPD) displays a baseline
physiological dead space to tidal volume ratio (V_D/V_T) of 0.9. According to the text, what physiological
state functions as an important compensatory mechanism to maintain metabolic carbon dioxide excretion in
this patient?
...
CORRECT ANSWER: B
Rationale: The text states: "An important compensatory mechanism is that a lower level of ˙V_A will maintain stable
CO_2 excretion where the PaCO_2 is increased." Hyperventilating up to 50 L/min is impossible due to diminished
reserves.
Anesthesia Board Review Series
CONFIDENTIAL & PROPRIETARY - BOARD STUDY GUIDE Page 18

QUESTION 5
Which of the following anesthetic techniques is uniquely characterized in the text as preserving respiratory
muscle tone and preventing a reduction in Functional Residual Capacity (FRC) during mono-anesthesia?
...
CORRECT ANSWER: D
Rationale: The text states: "For example, maintenance of muscle tone using ketamine as the anesthetic does not reduce
FRC... Intravenous ketamine does not impair muscle tone and is the only individual anesthetic that does not cause
atelectasis."
Anesthesia Board Review Series
CONFIDENTIAL & PROPRIETARY - BOARD STUDY GUIDE Page 19`
    }
  ]
};
