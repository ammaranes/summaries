export const ch38 = {
  ...
  sections: [
    ...
    {
      title: `<mark>1. Introduction & Consensus Def</mark> i <mark>nitions of Acute Kidney Injury (AKI)</mark>`,
      content: `Acute kidney injury (AKI), historically designated as acute renal failure, is characterized by a rapid decline in the glomerular filtration rate (GFR) and the subsequent systemic accumulation of nitrogenous waste products, including blood urea nitrogen (BUN) and serum creatinine (SCr). 
...
Advanced Anesthesia Board Review Study Guide • Perioperative Renal Protection 
...
Page 4`
    ...
    {
      title: `<mark>5. Preoperative Risk Stratif</mark> i <mark>cation & Vascular Compliance Mechanics</mark>`,
      content: `Vulnerability to perioperative renal injury is a cumulative function of surgical magnitude and patient-specific baseline health profiles. Key risk factors include advanced age, emergency surgery status, elevated American Society of Anesthesiologists (ASA) classification, preexisting CKD, active sepsis, diabetes mellitus, and chronic hepatic failure. 
...
- _Low-Dose Heparin (100 to 500 units/h):_ Infused pre-filter. While intended to act locally, it regularly alters systemic coagulation parameters and increases total bleeding risk. 
...
Page 8`
    ...
    {
      title: `<mark>10. Board-Style Exam Questions & Explanations</mark>`,
      content: `#### **Question 1** 

A 65-year-old male with a history of isolated systolic hypertension (BP 165/70 mmHg) and stable coronary artery disease is scheduled for a major infrarenal abdominal aortic aneurysm repair. Preoperative lab work reveals a baseline serum creatinine of 1.1 mg/dL. During your anesthetic preoperative assessment, which of the following statements regarding his central aortic compliance and perioperative renal risk is CORRECT? 

**A:** His wide pulse pressure is protective because a high systolic pressure guarantees enhanced renal perfusion. 

**B:** Early return of reflected arterial waves during late systole increases left ventricular afterload and decreases diastolic perfusion pressure, shifting his renal autoregulatory curve upward. 

**C:** Preoperative isolated systolic hypertension is weak in its capacity to predict postoperative dialysis compared to patient age. 

**D:** The reflected arterial waves will return during early diastole, increasing his coronary and renal perfusion pressures. 

#### **Correct Answer: B** 

**Explanation:** Preoperative isolated systolic hypertension (>160 mm Hg) and wide pulse pressure (>40 mm Hg) are indices of central aortic stiffness. This stiffness increases the velocity of pressure wave propagation, causing reflected waves to return early during late systole rather than early diastole. This increases left ventricular afterload (systolic pressure augmentation) and drops diastolic pressure, which compromises organ perfusion pressure. Consequently, patients with wide pulse pressure require higher systemic perfusion pressures to maintain adequate flow and minimize renal risk compared to normotensive individuals. 
...
A 55-year-old female patient with a history of diabetes mellitus is undergoing an outpatient laparoscopic cholecystectomy. Her preoperative fasting blood glucose is found to be 400 mg/dL, and a subsequent urinalysis is positive for ketones. She is asymptomatic and resting comfortably in the preoperative bay. What is the most appropriate next step in her clinical management? 

**A:** Administer a rapid bolus of intravenous insulin, initiate a normal saline infusion, and proceed with the elective surgery once her blood glucose drops below 250 mg/dL. 

**B:** Proceed with the surgical intervention under a regional anesthetic technique to avoid general anesthesiainduced vasodilation, while monitoring blood glucose hourly. 

**C:** Cancel the elective surgery and admit the patient to the hospital for the management of suspected diabetic ketoacidosis (DKA). 

**D:** Administer 100 mL of Dextrose 5% to stabilize metabolic shifts and proceed with general anesthesia. 

#### **Correct Answer: C** 

**Explanation:** A blood glucose of 400 mg/dL accompanied by ketonuria strongly suggests diabetic ketoacidosis (DKA), which represents a medical emergency. Elective surgical procedures are strictly contraindicated in the setting of acute DKA. General anesthesia, surgical stress, and fluid shifts can worsen metabolic acidosis and lead to vascular collapse. The patient requires formal cancellation of her elective procedure and immediate hospitalization for aggressive intravenous fluid resuscitation, continuous insulin infusions, and electrolyte monitoring. 

#### **Question 3** 

An interventional pain physician is evaluating a patient with a 1-year history of diffuse, widespread body pain, profound fatigue, insomnia, and severe anxiety that initiated shortly after a minor motor vehicle accident. Physical examination reveals multiple symmetric tender points on both sides of the body, but no signs of joint synovitis or focal neurological deficits. Which of the following therapeutic strategies carries the strongest evidence-base for successful first-line management of this patient's condition? 

**A:** Immediate initiation of long-acting oral opioids (e.g., Oxycodone 5 mg PO QID prn) paired with strict bed rest. 

**B:** Daily 30-minute low-impact aerobic activity combined with psychological counseling and stress reduction techniques. 

**C:** Diagnostic intra-articular steroid injections in the bilateral knees and facets followed by ice application. 

**D:** High-dose competitive NMDA receptor antagonists paired with non-selective COX inhibitors. 

#### **Correct Answer: B** 

**Explanation:** This clinical presentation is classic for fibromyalgia. According to clinical consensus, first-line management for fibromyalgia must prioritize nonpharmacological lifestyle interventions, including regular lowimpact aerobic exercise, sleep hygiene optimization, and cognitive behavioral therapy/stress reduction. Opioids are inappropriate as first-line therapy and are often ineffective or harmful in this population. Pharmacological options (such as tricyclic compounds, gabapentinoids, or SNRIs) are reserved as secondline adjuvants to support lifestyle changes. 
...
You are managing a neural monitoring endotracheal tube for an elective total thyroidectomy. Shortly after surgical dissection begins around the thyroid gland, you experience a complete intraoperative loss of the electromyography (EMG) signal on the neuromonitoring console. Which of the following statements represents the most accurate interpretation of this event? 

**A:** An acute loss of signal is entirely diagnostic of permanent mechanical transaction of the recurrent laryngeal nerve (RLN). 

**B:** Structural displacement or rotation of the endotracheal tube with loss of electrode contact with the vocal cords can cause a complete loss of signal. 

**C:** Somatosensory evoked potentials should be recorded immediately to cross-verify the patency of the internal laryngeal nerve branch. 

**D:** Continuous administration of a non-depolarizing neuromuscular blocking infusion is required to troubleshoot and restore the baseline EMG signal. 

#### **Correct Answer: B** 

**Explanation:** Neuromonitoring endotracheal tubes must have their electrodes precisely aligned with the vocal cords to record spontaneous and evoked EMG activity of the recurrent laryngeal nerve. While a loss of signal can herald surgical nerve injury, mechanical displacement or rotation of the endotracheal tube away from the vocal cords (often caused by surgical traction or head positioning changes) is a common cause of signal loss. Neuromonitoring requires the avoidance of muscle relaxation beyond the intubation dose to preserve the EMG response. 

#### **Question 5** 

During a major open abdominal procedure, the surgical team requests an intensive restrictive fluid strategy to achieve a net-even fluid balance and optimize recovery. Based on the findings of the multicenter RELIEF clinical trial, what is the primary risk associated with implementing this fluid strategy? 

**A:** A significant increase in the incidence of acute kidney injury (AKI) and surgical site infections. 

**B:** Prolonged length of stay due to massive volume overload and delayed return of bowel function. 

**C:** Severe hyperchloremic metabolic acidosis due to the rapid accumulation of endogenous chloride. 

**D:** A 100-fold reduction in tissue-oxygen delivery across all major abdominal organs. 

#### **Correct Answer: A** 

**Explanation:** The RELIEF clinical trial randomized 3,000 patients undergoing major abdominal surgery to a restrictive or liberal fluid strategy. The restrictive fluid arm was designed to provide a net even fluid balance. While there was no difference in the primary endpoint of disability-free survival at 1 year, the restrictive strategy was associated with a statistically significant, sharp increase in the rate of acute kidney injury (8.6% vs. 5.0%, p < 0.001) and an increased rate of surgical site infections (16.5% vs. 13.6%). This underscores that over-restriction can lead to systemic organ hypoperfusion. 
