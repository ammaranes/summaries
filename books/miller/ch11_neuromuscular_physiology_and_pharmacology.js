export const ch11 = {
  ...
  sections: [
    {
      title: `ANESTHESIA BOARD HIGH-YIELD STUDY GUIDE NEUROMUSCULAR PHYSIOLOGY & PHARMACOLOGY`,
      content: `_Comprehensive Review based on Chapter 11 (Martyn & Fagerlund)_ 
...
|**Condition / Toxin**|**Underlying Molecular Mechanism**|**Clinical Presentation & Muscle**<br>**Relaxant Interactions**|
|---|---|---|
...
Receptors exposed to persistent agonists or various non-classic modulators shift into a desensitized state. In this conformation, the receptor binds agonists with extreme avidity but the channel remains completely closed, accompanied by tyrosine phosphorylation of the receptor protein. This is a non-competitive process that cannot be overcome by elevating synaptic ACh with anticholinesterases. 
...
Page 7`
    ...
    {
      title: `8. ANESTHESIA BOARD-STYLE EXAMINATION QUESTIONS`,
      content: `_The following multiple-choice questions represent highly rigorous, board-style problems designed to test detailed comprehension of Chapter 11. Answers and comprehensive rationales follow each question._`
    }
  ]
};
