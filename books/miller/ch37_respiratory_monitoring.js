...
ANESTHESIA BOARD-STYLE PRACTICE`
    ...
    {
      title: `QUESTIONS`,
      content: `SELF-ASSESSMENT EXAMINATION
[source: 3603] 
*** ### Question 1 A 36-year-old female presents to the intensive care unit one week following an aneurysmal
subarachnoid hemorrhage (SAH). She demonstrates an acute onset of lethargy, mild confusion, and new-onset
right leg weakness. A transcranial Doppler study reveals a mean blood flow velocity (mBFV) of $145 ext{ cm/s}$
within the left middle cerebral artery. Which of the following represents the most appropriate initial management
strategy for this patient's condition? A. Initiate a continuous intravenous infusion of magnesium sulfate to target a
serum concentration of $3.0 ext{ mmol/L}$ B. Administer a continuous infusion of an antifibrinolytic agent such as
tranexamic acid C. Establish hypervolemic hemodilution via rapid administration of 5% albumin solution D. Maintain
normovolemia, induce controlled systemic hypertension, and continue oral nimodipine 
Correct Answer: D
Rationale: The clinical presentation is highly consistent with delayed cerebral ischemia (DCI) secondary to cerebral
vasospasm, which characteristically peaks 3 to 14 days following aneurysmal SAH. Oral nimodipine is a level 1A
recommendation demonstrated to improve neurological outcomes. Current guidelines advocate for the maintenance of
normovolemia (euvolemia) paired with induced systemic hypertension to optimize cerebral perfusion pressure across
the spastic, autoregulation-impaired vascular beds. Traditional aggressive "Triple-H" therapy featuring hypervolemia and
hemodilution is no longer recommended. Hypervolemia significantly increases risks of pulmonary edema, volume
overload, and cardiac events without improving neurological outcomes, while hemodilution impairs global oxygen
delivery. Antifibrinolytics and magnesium have not demonstrated clear efficacy in improving neurological outcomes
during active vasospasm. 
*** ### Question 2 A 50-year-old male is undergoing an emergency craniotomy in the sitting position for the
resection of a large posterior fossa mass. Intraoperatively, the anesthesia provider notes an abrupt, precipitous drop
in the end-tidal carbon dioxide ($P_{ET}CO_2$) from $36 ext{ mm Hg}$ to $14 ext{ mm Hg}$, accompanied by
sudden systemic hypotension and a variable pitch change on the precordial Doppler monitor. Which of the following
therapeutic actions is explicitly CONTRAINDICATED in the immediate management of this event? A. Discontinuing
nitrous oxide if in use and administering 100% inspired oxygen B. Instructing the surgical team to flood the
operative field with sterile normal saline C. Applying $10 ext{ cmH}_2 ext{O}$ of positive end-expiratory pressure
(PEEP) to the ventilator circuit D. Placing the patient in a relative Trendelenburg or left lateral decubitus position 
Anesthesia Board Review Guide: Respiratory Monitoring Page 11

Correct Answer: C
Rationale: The clinical triad of sudden hypotension, a profound drop in $P_{ET}CO_2$, and precordial Doppler pitch
alterations during a sitting craniotomy indicates a severe venous air embolism (VAE), caused by the negative pressure
gradient between the elevated surgical site and the right atrium. The application of positive end-expiratory pressure
(PEEP) is strictly contraindicated in this scenario because it elevates right-sided cardiac and venous pressures. In the
presence of a patent foramen ovale (PFO)—which occurs in approximately 20-25% of the population—this increase in
right atrial pressure can reverse the normal transatrial gradient, provoking a paradoxical air embolism into the systemic
arterial circulation, leading to acute stroke or myocardial infarction. Immediate appropriate steps include delivering 100%
$O_2$, flooding the surgical field with saline to halt air entrainment, applying bone wax, and repositioning the patient to
lower the surgical site relative to the heart. 
*** ### Question 3 An anesthesia provider is preparing a preoperative plan for a 68-year-old male with a history of
severe chronic obstructive pulmonary disease (COPD) scheduled for a lengthy L1–L5 posterior spinal fusion in the
prone position. When discussing strategies to optimize the patient for post-procedure extubation and prevent
postoperative airway compromise, which of the following statements is true based on current evidence? A.
Prophylactic administration of intravenous methylprednisolone is highly effective in reducing glottic and laryngeal
edema associated with prolonged prone positioning. B. Postoperative airway compromise within the first 12 hours
following cervical or upper spinal surgery is most frequently caused by progressive prevertebral and pharyngeal
edema. C. Diuresis with intravenous furosemide should be considered intraoperatively or postoperatively if volume
overload is suspected to mitigate interstitial fluid accumulation in a patient with poor lung compliance. D. Sizing of a
nasopharyngeal airway adjunct to bypass soft tissue obstruction is determined primarily by matching the internal
diameter of the patient's nares. 
Correct Answer: C
Rationale: Prone spinal fusion procedures often require substantial crystalloid administration over extended operative
times. Patients with underlying pulmonary disease or COPD are sensitive to interstitial fluid accumulation and volume
overload. Targeted diuresis with furosemide can reduce fluid burden and improve compliance to facilitate extubation.
Intravenous steroids have not demonstrated consistent clinical efficacy in mitigating glottic edema secondary to prone
positioning. Airway compromise manifesting within the immediate postoperative window (<12 hours) is most commonly
driven by wound hematoma formation, whereas pharyngeal and prevertebral edema characteristically peaks in the early
postoperative phase (12 to 72 hours). When selecting a nasopharyngeal airway, length (measured from the nose to the
tip of the earlobe) is the most critical factor to effectively bypass soft tissue obstruction, rather than diameter. 
*** ### Question 4 During a routine general anesthetic under volume-controlled ventilation with a constant
inspiratory flow and an activated end-inspiratory pause, the ventilator display demonstrates a sudden increase in
Peak Inspiratory Pressure ($P_{peak}$), while the Plateau Pressure ($P_{plat}$) remains completely unchanged at
its baseline value of $16 ext{ cmH}_2 ext{O}$. Which of the following conditions is the most likely cause of this
specific mechanical waveform alteration? A. Development of acute tension pneumothorax B. Kinking, biting, or
mucous plugging within the endotracheal tube lumen C. Mainstem bronchial intubation due to intraoperative patient
repositioning D. Acute expansion of extravascular lung water secondary to aggressive fluid resuscitation 
Anesthesia Board Review Guide: Respiratory Monitoring Page 12

Correct Answer: B
Rationale: Airway resistance is calculated as the difference between peak inspiratory pressure ($P_{peak}$) and
plateau pressure ($P_{plat}$) divided by inspiratory flow. An isolated increase in $P_{peak}$ with a completely stable
$P_{plat}$ reflects an increase in airway resistance ($P_{R}$). This is caused by mechanical factors narrowing the
internal diameter of the conducting system, such as tube kinking, a patient biting the tube, or intraluminal mucous
accumulation. Conversely, conditions affecting lung tissue compliance or elastance—such as tension pneumothorax,
mainstem intubation, or pulmonary edema—characteristically elevate both $P_{peak}$ and $P_{plat}$ simultaneously,
reducing static compliance and increasing the elastic pressure component ($P_E$). 
*** ### Question 5 A 42-year-old male is scheduled for a craniotomy and placement of a subdural grid for seizure
focus mapping. The neurosurgeon requests an anesthetic regimen that minimizes interference with intraoperative
electrocorticography (ECOG) and electroencephalographic (EEG) monitoring while providing an anticonvulsant
baseline. Which of the following techniques represents the most appropriate induction and maintenance strategy?
A. Induction with ketamine followed by maintenance with high-dose volatile sevoflurane at 2.0 MAC B. Induction
with etomidate followed by a continuous infusion of remifentanil and intermittent boluses of propofol C. Induction
with propofol followed by total intravenous anesthesia (TIVA) using a continuous infusion of propofol kept below
$50\\mu ext{g/kg/min}$, paired with remifentanil and dexmedetomidine D. Induction with thiopental followed by
maintenance using nitrous oxide combined with deep neuromuscular blockade 
Correct Answer: C
Rationale: For mapping of an epileptogenic focus via ECOG, maintaining a stable baseline without suppressing cortical
electrical activity is critical. Total intravenous anesthesia (TIVA) combining propofol, remifentanil, and dexmedetomidine
is a standard technique. Propofol infusions must be kept below $50\\mu ext{g/kg/min}$ to avoid complete EEG burst
suppression. Intermittent boluses must be avoided to ensure a steady state. Dexmedetomidine and remifentanil have
minimal impact on ECOG monitoring signals. High concentrations of volatile agents like sevoflurane ($>1.5 ext{ MAC}$)
can be epileptogenic in the presence of hypocapnia or suppress signals at higher doses, rendering mapping unreliable.
Etomidate has proconvulsant features that enhance high-quality spikes on EEG, making it a common choice for
electroconvulsive therapy (ECT) but less ideal for steady-state intraoperative focus localization. Deep neuromuscular
blockade must be avoided if motor mapping or electromyography (EMG) is concurrently planned. 
Anesthesia Board Review Guide: Respiratory Monitoring Page 13`
    }
  ]
};
