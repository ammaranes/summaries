...
- _Elderly:_ Decreased clearance and smaller central compartment due to lower cardiac output. Because of this and enhanced neural sensitivity, patients ≥ 80 years old require a 50% dose reduction compared to a 20-year-old. 
...
Anesthesia Board Review Core Curriculum • Dr. Ammar Bahamdeen 
...
- **Acute Intermittent Porphyria:** Barbiturates potently induce oxidative microsomes and stimulate γ- aminolevulinic acid (ALA) synthetase, precipitating a life-threatening porphyria attack. 
...
#### **S(+)-Ketamine Enantiomer Advantages:** 

The pure $S(+)$-isomer is 3 to 4 times more potent as an analgesic than the $R(-)$-isomer. It exhibits a 10% faster hepatic clearance and biotransformation, allows a quicker functional recovery, and produces fewer distressing psychomimetic emergence reactions.`
    },
    {
      title: `Pharmacodynamics & Systemic Effects`,
...
Page 8 of 14`
    ...
    {
      title: `<mark>8. HIGH-YIELD CLINICAL MATH & PHYSIOLOGY EQUATIONS</mark>`,
      content: `#### **1. Arterial Oxygen Content (** **_CaO_2_ )** 

The total oxygen content carried in arterial blood is calculated as: 
...
#### **2. Systemic Oxygen Delivery (** **_DO_2_ )** 

The total volume of oxygen delivered to the capillaries per minute is defined by: 
...
The driving pressure for cerebral blood flow is calculated as: 
